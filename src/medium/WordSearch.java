...
public class WordSearch {
    ...
    public static void main(String... args) {
        ...
        System.out.println(wordSearch.exist(board, ""));
    }

    private void dfs(int k, int x, int y, int m, int n, char[] c, char[][] board, boolean[][] t) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            int u = x + a[i];
            int v = y + b[i];
            if (u < 0 || v < 0 || u >= m || v >= n || t[u][v] || board[u][v] != c[k]) continue;
            t[u][v] = true;
            dfs(k-1, u, v, m, n, c, board, t);
            if (result) return;
            t[u][v] = false;
        }
    }
